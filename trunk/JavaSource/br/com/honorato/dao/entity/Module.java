...
public class Module implements Serializable {
	...
	private Module moduleReference;
	
	@OneToMany(fetch = FetchType.EAGER, cascade = CascadeType.ALL, mappedBy = "moduleReference")
	@OrderBy("name")
	private List<Module> resources;	
	
	public Module() {
    }
    
	public Module(Integer idModule, String name) {
		super();
	...
	public Module getModuleReference() {
		return moduleReference;
	}

	public void setModuleReference(Module moduleReference) {
		this.moduleReference = moduleReference;
	}
	
	public List<Module> getResources() {
		return resources;
	}

	public void setResources(List<Module> resources) {
